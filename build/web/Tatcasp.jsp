        ...
        <jsp:include page="contentrai.jsp"></jsp:include>
            ...
            <div class="hoversearch">
                <form action="SanPhamlaptop">  
                    ...
                    <input type='image' src="Images/Timkiem.png" width="60" height="38" alt="SUBMIT" name='action' class="cil" value='Add too carttrangsp'>
                </form> 
            </div>
                ...
                <div class="tongtrangchu">
                    ...
                    <div id="site-wrapper">
                        ...
                        <%
                            ...
                            List<Product> list = listSP.HienthiSPpro("");
                            request.setAttribute("Danhmucsp", list);

                        %>

                        <c:forEach var="pb" items="${Danhmucsp}">
