                ...
                <div class="tongtrangchu">
                    ...
                    <div id="site-wrapper">
                        ...
                        <%
                            ...
                            List<Product> list = listSP.HienthispKhuyenmai();
                            request.setAttribute("Sanphamkm", list);

                        %>

                        <c:forEach var="pb" items="${Sanphamkm}">
                                ...
                                <li class="preorder"><span class="tagimg "></span> 
                                    <a href="detail.jsp?ma_san_pham=" class="product-image"> 
                                        ...
                                        <span class="textkm">Khuyến mãi trị giá đến <strong>${pb.khuyenmai}</strong> 
                                            ...
                                            <input type='image' src="Images/addgiohang.png" alt="SUBMIT" name='action' class="cil" value='Add too cart'/>
                                        </span>
                                        <p class="info">
